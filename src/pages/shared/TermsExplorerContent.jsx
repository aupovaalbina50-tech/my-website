...
function TermsExplorerContent({ initialView = 'categories', lockView = false, termBasePath = '/terms' }) {
  ...
  const openTerm = (id) => navigate(`${termBasePath}/${id}`)
...
export default TermsExplorerContent
