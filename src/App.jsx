...
const TAB_IDS = ['search', 'add', 'quotes', 'ministry', 'committees', 'docs']
...
function App() {
  ...
  return (
    <>
      ...
      <nav className="tabs-bar" aria-label={t.nav.aria}>
        <div className="tabs">
          {TAB_IDS.map((id) => (
            <button
              key={id}
      ...
      <section id="add" className="section-add">
        <div className="card">
          ...
          <form className="term-form" onSubmit={handleAdd}>
            <div className="field">
              <label htmlFor="ru">{t.langNames.ru}</label>
              <input
                id="ru"
                type="text"
                value={form.ru}
            ...
            <div className="field">
              <label htmlFor="kk">{t.langNames.kk}</label>
              <input
                id="kk"
                type="text"
                value={form.kk}
            ...
            <div className="field">
              <label htmlFor="en">{t.langNames.en}</label>
              <input
                id="en"
                type="text"
                value={form.en}
